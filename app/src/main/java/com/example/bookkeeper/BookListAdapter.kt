...
class BookListAdapter(private val context : Context, private var onDeleteClickListener: OnDeleteClickListener) :
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        holder.setData(book.book,book.last_updated, position)
        holder.setListeners()
    ...
    inner class BookViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        ...
        fun setListeners(){
            itemView.setOnClickListener{
                ...
                intent.putExtra("lastUpdated", getFormattedDate(bookList[pos].last_updated))
